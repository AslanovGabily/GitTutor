...
# Описание Гита с официального аккаунта
# Git Guide
...
This command saves the credentials in `~/.git-credentials` in plain text.

If the password is changed, remove this file and execute a `git pull` to update it.

### Git Commit Starting with `#`

`git commit --cleanup=whitespace`

This will disable the comments with `#`.

### Avoid "Merge remote-tracking branch ..." commit message

> Reference: https://stackoverflow.com/a/6406947
